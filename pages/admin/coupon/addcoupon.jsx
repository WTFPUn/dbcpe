          ...
          <div className="flex flex-col w-[75%] bg-[#FAFCFE] h-[80%] rounded-md p-8 gap-4">
            <div className="flex w-full place-items-center gap-4">
              <div className="w-[75%] flex flex-col">
                <label className="text-black font-semibold">Coupon Code</label>
                <div className="w-full flex place-items-center border border-[#C4C4C4] rounded-md mt-2">
                  <input 
                    ...
                    onChange={(e) => setCoupon({...coupon, code_name: e.target.value})}
                    onBlur={verifyCode}
                  />
                  {codeVerify === 0 ? <p className=" text-green-400">🗸</p> 
                  :
                  codeVerify === 1 & coupon.code_name.length > 0 ? <p className=" text-red-400">✖</p> : null}
                </div>
              </div>
              <div 
                className="w-[25%] bg-[#6C6EF2] text-white h-max rounded-md py-2 px-4 self-end text-center "
                onClick={verifyCode}
                >
                  VERIFY
              </div>
            ...
            <div className="flex w-full gap-4">
              <div className="flex flex-col w-[50%]">
                ...
                <select
                  ...
                  onChange={(e) => setCoupon({...coupon, code_type: e.target.value})}
                >
              ...
              <div className="flex flex-col w-[50%]">
                ...
                <input 
                  ...
                  onChange={(e) => setCoupon({...coupon, discount_factor: e.target.value})}
                  min={0}
            ...
            <div className="w-[50%] pr-4">
              ...
              <input
                ...
                onChange={(e) => setCoupon({...coupon, count_limit: e.target.value})}
                min={0}
              />
            </div>
            <div className="w-[50%] pr-4">
              ...
              <input
                ...
                onChange={(e) => setCoupon({...coupon, expired_date: e.target.value})}
              />
            </div>
